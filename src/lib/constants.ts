...
export const LOCATIONS = [
  ...
  },
  {
    id: 'pro',
    name: '선수반 전용시설',
    address: '경기도 시흥시 (선수반 입단 상담 후 안내)',
    phone: '010-9159-3339',
    consultPhone: '010-9159-3339',
    naverBookingUrl: '',
    mapUrl: '',
    naverMapEmbedId: '',
    kakaoMapUrl: '',
